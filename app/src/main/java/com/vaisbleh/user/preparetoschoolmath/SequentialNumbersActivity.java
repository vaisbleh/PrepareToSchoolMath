...
public class SequentialNumbersActivity extends AppCompatActivity implements View.OnClickListener {

    private ImageView image1, image2,image3, image4, image5, image6, image7, image8, image9, image10, imageView1, imageView2,
    ...
    private int[] emptyNum = new int[2];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sequential_numbers);
        ...
        row = new ImageView[]{image1,image2, image3, image4, image5, image6, image7, image8, image9, image10};
            ...
            if(view.getId() == numbers.get(i).getId()){
                if(count == 0){
                    if(i == emptyNum[0]){
                        ...
                        row[i].setImageBitmap(BitmapFactory.decodeResource(getResources(), nums[i]));
                        Toast.makeText(this, "OK", Toast.LENGTH_SHORT).show();
                        count++;
                        row[emptyNum[1]].setBackgroundColor(Color.RED);
                    }else{
    ...
    private void getRow(){
        ...
        for (int i = 0; i < emptyNum.length; i++) {
            ...
            if(i == 0){
                row[rand].setImageDrawable(null);
                emptyNum[i] = rand;
                row[rand].setBackgroundColor(Color.RED);
            }else {
                while (rand == emptyNum[0]){
