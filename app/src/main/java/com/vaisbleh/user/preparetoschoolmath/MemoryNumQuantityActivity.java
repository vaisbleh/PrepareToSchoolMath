...
public class MemoryNumQuantityActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static int[] circles = new int[]{R.drawable.one_circle, R.drawable.two_circle, R.drawable.three_circle, R.drawable.four_circle, R.drawable.five_circle,
            R.drawable.six_circle, R.drawable.seven_circle, R.drawable.eight_circle, R.drawable.nine_circle};
    private static int[] squares = new int[]{R.drawable.one_square, R.drawable.two_square, R.drawable.three_square, R.drawable.four_square, R.drawable.five_square,
            R.drawable.six_square, R.drawable.seven_square, R.drawable.eight_square, R.drawable.nine_square};
    private static int[] triangles = new int[]{R.drawable.one_triangle, R.drawable.two_triangle, R.drawable.three_triangle, R.drawable.four_triangle, R.drawable.five_triangle,
            R.drawable.six_triangle, R.drawable.seven_triangle, R.drawable.eight_triangle, R.drawable.nine_triangle};
    private static int[] stars = new int[]{R.drawable.one_star, R.drawable.two_star, R.drawable.three_star, R.drawable.four_star, R.drawable.five_star,
            R.drawable.six_star, R.drawable.seven_star, R.drawable.eight_star, R.drawable.nine_star};
    private ArrayList<Integer> currentNums = new ArrayList<>();
    private ArrayList<Integer> currentQuantities = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory_num_quantity);
    ...
    public void onClick(View view) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if(view.getId() == imageArray1.get(i).getId() || view.getId() == imageArray2.get(i).getId()){
                if(count == 0){
                    if(view.getId() == imageArray1.get(i).getId()){
                        selected.setImageBitmap(BitmapFactory.decodeResource(getResources(),currentNums.get(i)));
                    }else {
                        selected.setImageBitmap(BitmapFactory.decodeResource(getResources(),currentQuantities.get(i)));
                    }
                    checkNum1 = i;
    ...
    private void getNumsArray(){
        ...
        for (int i = 0; i < circles.length; i++) {
            ...
            switch (ran){
                case 1:
                    currentQuantities.add(circles[i]);
                    break;
                case 2:
                    currentQuantities.add(squares[i]);
                    break;
                case 3:
                    currentQuantities.add(triangles[i]);
                    break;
                default:
                    currentQuantities.add(stars[i]);
            }
        }

        currentQuantities.remove(rand);
    }
